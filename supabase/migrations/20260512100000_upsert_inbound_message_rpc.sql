...
--
-- Executa os 3 upserts (message → thread → contact) dentro de
-- uma única transação PostgreSQL, eliminando estados inconsistentes
-- onde o sidebar mostra uma last_message que não existe na tabela
-- messages, ou vice-versa.
--
-- Parâmetros (todos JSONB para flexibilidade de schema):
...
-- A exceção é capturada internamente para que o chamador possa
-- distinguir erros SQL de erros de rede sem retry desnecessário.
-- ============================================================
