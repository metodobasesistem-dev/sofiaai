...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_messages_whatsapp_id_user 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_threads_user_last_msg 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_contacts_telefone_pattern 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_messages_status_user 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_threads_ticket_status 
  ON public.threads (user_id, ticket_status);

-- 8. Índice parcial para threads com foto a atualizar
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_threads_photo_update 
